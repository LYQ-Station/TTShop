//
//  TSTransferContactNavController.m
//  TTShop
//
...
@implementation TSTransferContactNavController
...
- (id) initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        TSTransferContactController *ctrl = [[TSTransferContactController alloc] initWithStyle:UITableViewStylePlain];
